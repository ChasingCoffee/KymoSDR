...
| P1/P2 receive AF gain, mute and AGC | Shared startup/live controls and simulator amplitude profiles implemented | Both protocols pass gain/ceiling, mute, three-preset step/recovery and reconnect signal campaign | Hosted validation pending | [Gain contract/results](RECEIVE_GAIN.md); no hardware RF gain, calibrated levels, speech/noise or playback qualification. |
