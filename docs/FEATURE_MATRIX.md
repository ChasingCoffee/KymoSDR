...
| P2 simulator → native CM/WDSP audio | Initial loopback-only receive integration | Tone/retune, DDC/rate, loss, cancellation and lifecycle tests | New native/managed tests in CI; see validation record | [Receive boundary](P2_RECEIVE_INTEGRATION.md); hardware RX, P1, spectrum and soak tests still pending. |
