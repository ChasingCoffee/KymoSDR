...
| P1 simulator → native CM/WDSP receive | Shared P1/P2 owner, one 48 kHz RX, USB/LSB/filter/audio/spectrum | 14 signal checks, independent pinned reference, packet/lifecycle faults and ASan/UBSan pass | Same deterministic/native suite added to CI; independent reference runs on Linux/macOS only | [P1 boundary/results](P1_RECEIVE_INTEGRATION.md); hardware, higher rates, multi-RX, TCP and P1 TX unqualified. |
