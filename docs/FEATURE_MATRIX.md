...
| Simulated receive endurance / fault campaign | Implemented; short CI and opt-in 30-minute mode | 128 managed regressions pass, including fault/cancellation/cleanup tests; final long run in progress | New campaign qualification pending | [Campaign contract](RECEIVE_SOAK.md); resource figures are process diagnostics, not hardware/leak/performance-budget qualification. |
