...
| Simulated receive endurance / fault campaign | Implemented; short CI and opt-in 30-minute mode | 135 managed tests pass; 30-minute checkpoint at c755f191 and final-source ten-minute/ten-reconnect campaign pass | Short campaign and 135 managed tests pass on both; Linux sanitizers pass | [Exact sources/results](NATIVE_CI_RESULTS.md#simulator-backed-receive-endurance-and-fault-campaign); reconnect RSS growth remains open, especially Linux. No hardware or memory/performance-budget qualification. |
