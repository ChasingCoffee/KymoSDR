...
| P2 simulated RX spectrum frames | Loopback-only integration passes cross-platform; renderer-independent and uncalibrated | 121 managed tests, 8 native tests; frequency/level/retune, coalescing, buffer ownership and sanitizer checks pass | 121 managed tests and native/CLI checks pass on both; Linux active-spectrum ASan/UBSan/leak checks pass | [Frame contract](P2_RECEIVE_INTEGRATION.md#spectrum-frame-contract); no rendered UI or live-radio spectrum yet. |
