...
| P2 simulated RX spectrum frames | Implemented, renderer-independent and uncalibrated | 121 managed tests, 8 native tests; frequency/level/retune, coalescing and buffer ownership pass | New spectrum CI validation pending; see source-specific results | [Frame contract](P2_RECEIVE_INTEGRATION.md#spectrum-frame-contract); no rendered UI or live-radio spectrum yet. |
