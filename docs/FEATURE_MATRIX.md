...
| G2/P2 receive simulator | Standalone .NET loopback peer | Discovery, synthetic I/Q, controls/faults and 100 lifecycle tests pass | Hosted checks pending | [Simulator scope](G2_SIMULATOR.md); not native RX/WDSP or hardware qualification. |
