...
namespace Thetis
{
    unsafe partial class NetworkIO
    {
        ...
        public static extern int nativeInitMetis(String netaddr, int port, String localaddr, int localport, int protocol, int model_id, int p2hw_uses_differnt_ports);
