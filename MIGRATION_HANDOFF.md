...
- VERIFIED 2026-08-22 on RX 580 machine: 5 ErrorLog entries across two on/off toggle cycles — startup Hardware/RX580/FL12.0 ↔ WARP/'Microsoft Basic Render Driver'/FL12.1 (forced CPU), clean live re-inits both directions, no errors. FL difference HW-vs-WARP is expected. Still unverified: RDP/device-removal auto-downgrade path, meter init log line presence.
